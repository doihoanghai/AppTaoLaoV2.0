...
{
    public class PSTKKQPhieuMail
    {

        public int MauMoi { get; set; }
        public int MauXNL { get; set; }


        public int NguyCoThap { get; set; }
        ...
        public int G6PD2 { get; set; }
        public int GAL2 { get; set; }
